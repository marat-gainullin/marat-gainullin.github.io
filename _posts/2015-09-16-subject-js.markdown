...
на первый план начало выходить отношеное прикладной логики к технологиям,
...
пользуется в своей программе объектами синхронизации? Слава богу нет.

Любой ORM так же отделяет прикладную логику приложения от технологий хранения данных.
